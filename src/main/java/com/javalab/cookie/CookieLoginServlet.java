      ...
      System.out.println("doPost");
       ...
       // 1. 파라미터 추출
        ...
        if(member != null) { // 회원 존재
           ...
           /*
            * [forward와 return]
            * 메소드가 끝나기 전에 forward를 하면 바로 제어가 이동되지 않고
            * 아랫 문장 계속 수행함. 그러다가 널포인터 익셉션 발생할 가능성 있음.
            * 그래서 return을 해서 메소드를 완전히 빠져나가도록 해줘야 함.
            */
           RequestDispatcher dispatcher = 
        		   request.getRequestDispatcher("/cookie/loginForm.jsp");
